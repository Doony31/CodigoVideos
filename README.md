...
Código fuente de mis videos de programación en C++ (estructuras de datos, punteros, videojuegos básicos y más). Cada carpeta corresponde a un video de mi canal de YouTube: https://www.youtube.com/@Donny32
...
| [Secuencia de Figuras](Figuras/) | [[URL del video](https://youtu.be/oeMFySAFtbI?si=mbWtNr9p7GP0_cR2)] | Figuras y patrones |

## Cómo compilar

Todos los ejemplos fueron hechos con Visual Studio 2022 (C++), pero compilan con cualquier compilador moderno (g++, clang).
